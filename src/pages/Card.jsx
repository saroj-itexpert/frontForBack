...
<div>
  ...
  <div className="max-w-sm rounded overflow-hidden shadow-lg" style={{fontFamily: '"Strait", sans-serif'}}>
    ...
    <div className="px-6 py-4">
      <div className="font-bold text-xl mb-2">Harry Potter</div>
    ...
    <div className="px-6 pt-4 pb-2">
      ...
      <span className="inline-block bg-gray-200 rounded-full px-3 py-1 text-sm font-semibold text-gray-700 mr-2 mb-2">#Mystery</span>
      <span className="inline-block bg-gray-200 rounded-full px-3 py-1 text-sm font-semibold text-gray-700 mr-2 mb-2">#Magic</span>
    </div>
  </div>
</div>
    </>
